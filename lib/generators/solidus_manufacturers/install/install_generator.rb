    ...
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_javascripts
        append_file 'vendor/assets/javascripts/spree/backend/all.js',
          "//= require spree/backend/solidus_manufacturers\n"
        append_file 'vendor/assets/javascripts/spree/frontend/all.js',
          "//= require spree/frontend/solidus_manufacturers\n"
      end

      def add_migrations
        run 'bin/rake solidus_manufacturers:install:migrations'
      end
